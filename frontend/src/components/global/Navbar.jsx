...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-slate-900 to-brand-primary text-white relative z-50 shadow-md">
            ...
            {menuItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <Link 
                    to={item.path}
                    className={`px-4 xl:px-6 py-4 h-full text-sm font-bold uppercase tracking-wider flex items-center gap-1 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-brand-primary
                      ${active 
                        ? 'border-b-[3px] border-brand-primary text-white bg-white/10' 
                        : 'hover:bg-blue-800/40 hover:text-white border-b-[3px] border-transparent'
                      }`}
      ...
      >
        <div className="bg-gradient-to-r from-slate-900 to-brand-primary">
