      ...
      <div className="container-main">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-xl font-bold uppercase tracking-wider border-b border-gray-700 pb-2">Disdukcapil</h3>
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-lg font-bold uppercase tracking-wider border-b border-gray-700 pb-2">Navigasi Cepat</h3>
          ...
          {/* Kolom 3: Kontak */}
          <div className="flex flex-col space-y-4">
            <h3 className="text-lg font-bold uppercase tracking-wider border-b border-gray-700 pb-2">Kontak Kami</h3>
            <ul className="flex flex-col space-y-3 text-sm text-gray-400">
              <li className="flex items-start">
                <MapPin size={18} className="mr-3 text-brand-primary shrink-0 mt-0.5" aria-hidden="true" />
              ...
              <li className="flex items-center">
                <img src={phoneLogo} alt="Phone" className="w-[18px] h-[18px] mr-3 shrink-0" aria-hidden="true" />
                <span>{contactData.contactLinks.phone.value}</span>
              </li>
              <li className="flex items-center">
                <img src={gmailLogo} alt="Email" className="w-[18px] h-[18px] mr-3 shrink-0" aria-hidden="true" />
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-lg font-bold uppercase tracking-wider border-b border-gray-700 pb-2">Ikuti Kami</h3>
