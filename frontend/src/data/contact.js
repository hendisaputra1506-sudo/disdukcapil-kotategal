export const contactData = {
  ...
  contactLinks: {
    ...
    facebook: {
      platform: "Facebook",
      label: "Disdukcapil Kota Tegal",
      value: "Disdukcapil Kota Tegal",
      url: "https://facebook.com/disdukcapiltegalkota",
      icon: "facebook.svg",
      description: "Halaman resmi Facebook"
    },
    tiktok: {
      platform: "TikTok",
      label: "@disdukcapilkotategal",
      value: "@disdukcapilkotategal",
      url: "https://tiktok.com/@disdukcapilkotategal",
      icon: "tiktok.svg",
      description: "Video informasi terbaru"
    },
    x: {
      platform: "X (Twitter)",
      label: "@disdukcapiltegal",
      value: "@disdukcapiltegal",
      url: "https://x.com/disdukcapiltegal",
      icon: "x.svg",
      description: "Update cepat dari X"
    },
