 ...
 */
const NewsCard = ({ id, slug, title, date, author, category, image, excerpt, baseUrl = '/informasi' }) => {
  return (
    <Card hoverable className="flex flex-col h-full group">
      ...
      <div className="flex flex-col flex-grow p-6">
        ...
        {/* Title */}
        <Link to={`${baseUrl}/${id}`} className="focus-visible:outline-none focus-visible:underline group-hover:text-brand-primary transition-colors">
